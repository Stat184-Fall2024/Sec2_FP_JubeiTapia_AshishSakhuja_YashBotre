...
```{r}
#code for distribution of danceability
```

\[INSERT FIGURE 4a,b,c,d,e (interval for danceability)\] 

\[INSERT DATA ANALYSIS ON FIGURE 4a,b,c,d,e\] 

\[INSERT SUMMARY TABLE FOR DATA\] 

\[EXPLAIN STATISTICS IN SUMMARY TABLE (should be about a page long)\] 
